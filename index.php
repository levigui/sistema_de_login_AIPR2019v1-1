...
<head>
    ...
    <title>Sistema de Login Becker Systems</title>
    <style>
        #caixaCadastro,
        #caixaRecuperarSenha,
        #alerta {
        ...
        <section class="row mb-5">
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaLogin">
                ...
                <form id="formLogin" class="p-2">
                    ...
                    <div class="form-group">
                        <input type="password" name="senhaUsuario" id="senhaUsuario" class="form-control" placeholder="Senha" required minlength="6" required value="<?php 
